...
exports.updateCropBoxByHandle = updateCropBoxByHandle;
/**
 * Computes updated crop box for Mode B (resizing crop box)
 */
function updateCropBoxByHandle(initialBox, handle, delta, containerSize, aspect, minBoxSize = 50) {
