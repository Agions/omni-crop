...
exports.getCropBoundaries = getCropBoundaries;
exports.clampPosition = clampPosition;
exports.getMinZoom = getMinZoom;
exports.applyDamping = applyDamping;
...
function getCropBoundaries(cropSize, mediaSize, rotation, zoom) {
    ...
    const { width: boundingWidth, height: boundingHeight } = (0, affine_1.getRotatedSize)(scaledWidth, scaledHeight, rotation);
 ...
 */
function applyDamping(offset, min, max, factor = 0.3) {
    if (offset < min) {
