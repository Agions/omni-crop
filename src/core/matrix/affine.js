 ...
 */
export function getInitialCropSize(containerWidth, containerHeight, aspect) {
 ...
 */
export function getMediaBaseSize(mediaWidth, mediaHeight, cropWidth, cropHeight) {
 ...
 */
export function computeCropArea(crop, cropSize, zoom, rotation, flip, naturalMediaSize, renderedMediaSize) {
